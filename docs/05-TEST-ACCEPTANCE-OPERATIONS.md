...
除注册安全矩阵外，公开 MVP 还必须覆盖 PRD v0.3.0 的 GATE-B。以下是最低验收矩阵：

| 需求 | 关键场景 | 必要证据 |
|---|---|---|
| `STUDENT-001` | 家庭/学生切换、跨租户和跨学生读写 | 权限负向测试、缓存与任务作用域测试 |
...
3. 修正一次识别候选并冻结新版本；
4. 生成判题候选，确认后写入正式错题；
5. 获得一项已验证推荐并完成一次复习作答；
6. 生成默认无答案的 A4 PDF；
7. 验证原图、候选、修订、正式记录和任务证据可追溯；
8. 切换到另一学生并证明任何数据、对象链接和任务均不串号。
