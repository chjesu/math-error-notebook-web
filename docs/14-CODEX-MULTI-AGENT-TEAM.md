...
产品/UX 审查确认 v0.4.0 候选已具备独立认证状态、个人页面、任务恢复和异常分类；后端/接口/浏览器 E2E、真实 MySQL smoke、134 项测试和独立安全复核已完成。本地手工闭环不等于生产完成；自动 OCR/AI 判题 Worker、权威题库迁移、PWA、运营后台、生产恢复和云部署明确延期。
