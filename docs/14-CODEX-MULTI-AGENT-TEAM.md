...
产品/UX 审查确认 v0.4.0 候选已具备独立认证状态、个人页面、任务恢复和异常分类；后端/接口/浏览器 E2E、真实 MySQL smoke、158 项测试和 Codex CLI 数学候选实测已完成。本地同步候选闭环不等于生产完成；生产异步 Worker、PDF/DOCX 自动解析、PWA、运营后台、生产恢复和云部署明确延期。
