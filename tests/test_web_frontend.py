...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_workbench_is_one_chat_flow_with_one_composer(self) -> None:
        ...
        self.assertIn('id="composer-action" class="composer-action"', html)
        self.assertIn('<option value="ask">询问</option>', html)
    ...
    def test_workbench_uses_harness_style_history_window_and_docked_interactions(self) -> None:
        ...
        self.assertIn('if (chatInput.value.trim() && actionSelect.value !== "ask") actionSelect.value = "ask"', script)
        ...
        self.assertIn(".composer-action", css)
